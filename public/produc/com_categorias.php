        ...
        <div class="content-wrapper">
          ...
          <div class="container-xxl flex-grow-1 container-p-y ">
            <div class=" d-flex justify-content-between">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Compras /</span> Categorías</h4>
            </div>
            <div class="row ">
              <div class="col-lg-12">
                <div class="card">
...
<script>
  ...
  $(document).ready(function(e) {
    $("#form").on('submit', function(e) {
      ...
      $.ajax({
        type: 'POST',
        url: '../../back/ajax/com_nueva_categoria.php',
        data: formData,
        contentType: false,
        cache: false,
        processData: false,
